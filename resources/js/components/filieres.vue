<template>
    <div class="container">
       <div class="col-12">
         ...
         <a class="btn btn-primary" @click="newModel" href="#" role="button" data-toggle="modal" data-target="#addnew" >add filiere <i class="fa fa-edit"/></a>
                  ...
                  <tbody>
                    <tr v-for="filiere in filieres.data" :key="filiere.id">
                      ...
                      <td>
                          ...
                          <a class="btn btn-primary" href="#" @click="DeleteFiliere(filiere.id)"  role="button">delete <i class="fa fa-edit"/></a>
                      </td>
