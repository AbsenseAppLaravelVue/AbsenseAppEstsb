<template>
    <div class="container">
       <div class="col-12">
         ...
         <a class="btn btn-primary" @click="newModel" href="#" role="button" data-toggle="modal" data-target="#addnew" >add matiere <i class="fa fa-edit"/></a>
                  ...
                  <tbody>
                    <tr v-for="matiere in matieres.data" :key="matiere.id">
                      ...
                      <td>
                          ...
                          <a class="btn btn-primary" href="#" @click="DeleteFiliere(matiere.id)"  role="button">delete <i class="fa fa-edit"/></a>
                      </td>
